  ...
  return (
    <div className="d-flex bd-highlight col-12 border rounded white ">
      <Row className="col-12 w-100 h-50 p-2">
        <Column className="col-6 d-flex justify-content-between align-items-start mt-2 ms-4">
          <div>All Updates</div>
        </Column>
        <Column className="col-6 d-flex justify-content-between align-items-center">
          <div>
            <div className="form-group ">
              <div className="show white w-25">show</div>
